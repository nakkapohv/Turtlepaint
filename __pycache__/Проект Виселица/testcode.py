...
HANGMAN = (  #Создаём кортеж куда помещяем саму виселицу и человечка, который будет постепенно появлятся при неправильом ответе 
    """
     ------
     |    |
     |
...
WORDS = ("Программирование", "Пайтон", "Линукс", "Кортеж", "Список", "Цикл")  # Слова для угадывания
